...
router.use(/^\/catalog\/(yardsale)\/(create)/, [	// catalog / author|book|bookinstance|genre
	function(req, res, next) {
		// Get the operation from req.params object.
...
router.use(/^\/catalog\/(yardsale)\/([a-zA-Z0-9]{1,})/, [		// catalog / author|book|bookinstance|genre
	function(req, res, next) {
