...
router.use(/^\/yardsales\/(username)\/([a-zA-Z0-9]{1,})\/(delete|update)/, [	// catalog / author|book|bookinstance|genre
...
router.use(/^\/yardsales\/(username)\/(create)/, [	// catalog / author|book|bookinstance|genre
	function(req, res, next) {
		// Get the operation from req.params object.
...
router.use(/^\/yardsales\/(username)\/([a-zA-Z0-9]{1,})/, [		// catalog / author|book|bookinstance|genre
	function(req, res, next) {
